...
import (
	...
	"github.com/onomyprotocol/reserve/testutil/network"
	"github.com/onomyprotocol/reserve/x/reserve/client/cli"
)
...
func TestCLI_CreateDenomProposal(t *testing.T) {
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			cmd := cli.CmdCreateDenomProposal()
