...
type Params struct {
	...
	MarketChannel string `protobuf:"bytes,5,opt,name=market_channel,json=marketChannel,proto3" json:"market_channel,omitempty"`
	// market_coin is the ibc address for collateral on market chain
	MarketCoin string `protobuf:"bytes,6,opt,name=market_coin,json=marketCoin,proto3" json:"market_coin,omitempty"`
	// reserve_coin is the ibc address for collateral on reserve chain
	ReserveCoin string `protobuf:"bytes,7,opt,name=reserve_coin,json=reserveCoin,proto3" json:"reserve_coin,omitempty"`
}
...
func (m *Params) GetMarketCoin() string {
	if m != nil {
		return m.MarketCoin
	}
	return ""
...
func (m *Params) GetReserveCoin() string {
	if m != nil {
		return m.ReserveCoin
	}
	return ""
}
...
var fileDescriptor_327732f0d7364169 = []byte{
	...
	,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x8f, 0x12, 0x38, 0xfa, 0xb0, 0x00, 0xac, 0x80,
	0xb3, 0x4a, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x2a, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff,
	0xff, 0x58, 0x2c, 0x4f, 0x61, 0x62, 0x01, 0x00, 0x00,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ReserveCoin) > 0 {
		i -= len(m.ReserveCoin)
		copy(dAtA[i:], m.ReserveCoin)
		i = encodeVarintParams(dAtA, i, uint64(len(m.ReserveCoin)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.MarketCoin) > 0 {
		i -= len(m.MarketCoin)
		copy(dAtA[i:], m.MarketCoin)
		i = encodeVarintParams(dAtA, i, uint64(len(m.MarketCoin)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarketCoin", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MarketCoin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReserveCoin", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReserveCoin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
