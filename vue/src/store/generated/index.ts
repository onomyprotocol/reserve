...
import ReserveOnomyprotocolReserveReserve from './reserve/onomyprotocol.reserve.reserve'
import ReserveReserveReserve from './reserve/reserve.reserve'
...
export default { 
  ...
  ReserveOnomyprotocolReserveReserve: load(ReserveOnomyprotocolReserveReserve, 'onomyprotocol.reserve.reserve'),
  ReserveReserveReserve: load(ReserveReserveReserve, 'reserve.reserve'),
